...
public class Aspirant {
    ...
    public void setNom(String nom) throws JPAException {
        if (("").equals(nom.trim()) || nom == null) {
            throw new JPAException("ERROR: nom incorrecte.");
        }
        this.nom = nom;
    }
    ...
    public void setLlinatges(String llinatges) throws JPAException {
        if (("").equals(llinatges.trim()) || llinatges == null) {
            throw new JPAException("ERROR: llinatges incorrectes.");
        }
