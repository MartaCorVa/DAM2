...
public class MainActivity extends AppCompatActivity implements LlistaFragment.VinsListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        frgLlista.setVinsListener(this);
        // assignam la resposta a través de la interfície (onViSeleccionat)
    ...
    public void onViSeleccionat(String vi) {
        ...
        if(horitzontal) {
            ...
            //((DetallFragment) getSupportFragmentManager().findFragmentById(R.id.FrgDetall)).notificar(vi);
        }
        else {
            // estam en vertical
